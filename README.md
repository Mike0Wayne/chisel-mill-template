...
```sh
git clone git@github.com:Mike0Wayne/chisel-mill-template.git
cd chisel-mill-template
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel-mill-template'
...
```sh
mill chisel-mill-template.test
```
